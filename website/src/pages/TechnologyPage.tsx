    ...
    <section className="py-20 sm:py-32 bg-gray-900 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Sous le capot : la technologie au service de la fiabilité</h2>
          <p className="mt-4 text-lg text-gray-400">Nous avons choisi des fondations techniques robustes pour garantir une application stable et prête pour l'avenir.</p>
        </div>
          ...
          <div>
            ...
            <div className="space-y-4">
               <ArchLayer icon={<Smartphone className="mr-2"/>} name="App (UI Layer)" color="blue">
                 <p>Une interface utilisateur cross-platform (iOS/Android) développée en React Native pour une expérience fluide et réactive.</p>
               </ArchLayer>
               <div className="text-center text-gray-400">↓</div>
               <ArchLayer icon={<Layers className="mr-2"/>} name="Adapter (Infrastructure)" color="purple">
                 <p>C'est ici que la logique métier rencontre le monde réel : bases de données, services externes, notifications...</p>
               </ArchLayer>
                <div className="text-center text-gray-400">↓</div>
               <ArchLayer icon={<Cpu className="mr-2"/>} name="Core (Application & Domain)" color="green">
                 <p>Le cerveau de l'application. Une logique métier pure et testable, indépendante de toute technologie externe.</p>
               </ArchLayer>
            </div>
          </div>
          <div>
            <h3 className="text-2xl font-bold text-center text-white mb-8">Stack Technologique</h3>
            <p className="text-center text-gray-400 -mt-6 mb-8">Les outils que nous utilisons et que nous aimons.</p>
