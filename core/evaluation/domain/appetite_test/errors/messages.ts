  ...
  ENTITY: {
    VALIDATION: {
      NAME_EMPTY: {
        ...
        code: "AT001",
        message:
          "Appetite test reference name can't be empty.Please change the name and retry.",
      },
    },
  },
  SERVICE: {
    APPETITE_TEST_REF_NOT_FOUND: {
      ...
      code: "AT002",
      message:
        "Appetite test reference not found. Without this is not possible to make appetite test.",
    },
