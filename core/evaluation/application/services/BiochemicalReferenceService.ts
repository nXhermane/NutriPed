...
export class BiochemicalReferenceService
  implements IBiochemicalReferenceService
{
  constructor(private readonly ucs: BiochemicalReferenceServiceUseCases) {}
  async create(
    req: CreateBiochemicalReferenceRequest
  ...
  async get(
    req: GetBiochemicalReferenceRequest
  ): Promise<AppServiceResponse<BiochemicalReferenceDto[]> | Message> {
    const res = await this.ucs.getUC.execute(req);
    if (res.isRight()) return { data: res.value.val };
    else return new Message("error", JSON.stringify((res.value as any)?.err));
  }
  async update(
    req: UpdateBiochemicalReferenceRequest
  ): Promise<AppServiceResponse<BiochemicalReferenceDto> | Message> {
  ...
  async delete(
    req: DeleteBiochemicalReferenceRequest
  ): Promise<AppServiceResponse<BiochemicalReferenceDto> | Message> {
