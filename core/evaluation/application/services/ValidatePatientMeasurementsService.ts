...
export class ValidatePatientMeasurementsService
  implements IValidatePatientMeasurementsService
{
  constructor(
    private readonly ucs: ValidatePatientMeasurementsServiceUseCases
  ) {}
  async validate(
