...
export class CreateDataFieldRefUseCase
  implements UseCase<CreateDataFieldRefRequest, CreateDataFieldRefResponse>
{
  constructor(
    private readonly generateId: GenerateUniqueId,
    private readonly repo: DataFieldReferenceRepository
  ) {}
  async execute(
    request: CreateDataFieldReference
  ): Promise<CreateDataFieldRefResponse> {
    try {
