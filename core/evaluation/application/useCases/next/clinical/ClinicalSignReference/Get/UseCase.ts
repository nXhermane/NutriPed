import { ApplicationMapper, Guard, handleError, left, Result, right, SystemCode, UseCase } from "@/core/shared";
...
export class GetClinicalSignReferenceUseCase implements UseCase<GetClinicalSignReferenceRequest, GetClinicalSignReferenceResponse> {
    constructor(private readonly repo: NextClinicalDomain.ClinicalSignReferenceRepository, private readonly mapper: ApplicationMapper<NextClinicalDomain.ClinicalSignReference, NextClinicalDtos.ClinicalSignReferenceDto>) { }
