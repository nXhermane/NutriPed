...
export class GetBiochemicalReferenceUseCase
  implements
    UseCase<GetBiochemicalReferenceRequest, GetBiochemicalReferenceResponse>
{
  constructor(
  ...
  async execute(
    request: GetBiochemicalReferenceRequest
  ): Promise<GetBiochemicalReferenceResponse> {
    try {
