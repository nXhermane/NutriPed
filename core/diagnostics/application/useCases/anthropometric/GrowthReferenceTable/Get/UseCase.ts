...
export class GetGrowthReferenceTableUseCase
  implements
    UseCase<GetGrowthReferenceTableRequest, GetGrowthReferenceTableResponse>
{
  constructor(
  ...
  async execute(
    request: GetGrowthReferenceTableRequest
  ): Promise<GetGrowthReferenceTableResponse> {
    try {
