...
export class GetGrowthReferenceChartUseCase
  implements
    UseCase<GetGrowthReferenceChartRequest, GetGrowthReferenceChartResponse>
{
  constructor(
  ...
  async execute(
    request: GetGrowthReferenceChartRequest
  ): Promise<GetGrowthReferenceChartResponse> {
    try {
