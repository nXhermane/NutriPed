  ...
  toResponse(
    ...
    return {
      ...
      growthIndicatorValues: entity
        ...
        .map(this.mapGrowthIndicatorValue),
      biologicalInterpretation: entity
        .getBiologicalInterpretation()
        .map(this.mapBiologicalResult),
      clinicalAnalysis: entity
        .getClinicalAnalysis()
        .map(this.mapClinicalAnalysisResult),
      globalDiagnostics: entity
        .getGlobalDiagnostics()
        .map(this.mapGlobalDiagnostic),
      createdAt: entity.createdAt,
      updatedAt: entity.updatedAt,
    };
  }
  private mapGrowthIndicatorValue(
