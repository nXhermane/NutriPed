...
export class GetOrientationRefUseCase
  implements UseCase<GetOrientationRefRequest, GetOrientationRefResponse>
{
  constructor(
  ...
  async execute(
    request: GetOrientationRefRequest
  ): Promise<GetOrientationRefResponse> {
    try {
