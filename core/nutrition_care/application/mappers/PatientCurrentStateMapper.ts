...
export class PatientCurrentStateMapper
  implements ApplicationMapper<PatientCurrentState, PatientCurrentStateDto>
{
  toResponse(entity: PatientCurrentState): PatientCurrentStateDto {
    ...
    return {
      ...
      complicationData: Object.fromEntries(
        Object.values(complicationData).map(value => [
          value.code,
          this.mapToValueTypeDto(value),
        ])
      ),
      biologicalData: Object.fromEntries(
        Object.values(biologicalData).map(value => [
          value.code,
          this.mapToValueTypeDto(value),
        ])
      ),
      anthropometricData: Object.fromEntries(
        Object.values(anthropometricData).map(value => [
          value.code,
          this.mapToValueTypeDto(value),
        ])
      ),
      appetiteTestResult: Object.fromEntries(
        Object.values(appetiteTestResult).map(value => [
          value.code,
          this.mapToValueTypeDto(value),
        ])
      ),
      clinicalSignData: Object.fromEntries(
        Object.values(clinicalSignData).map(value => [
          value.code,
          this.mapToValueTypeDto(value),
        ])
      ),
