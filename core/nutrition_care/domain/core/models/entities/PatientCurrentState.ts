...
export interface IPatientCurrentState extends EntityPropsBaseType {
  anthropometricData: Record<
    (typeof AnthroSystemCodes)[keyof typeof AnthroSystemCodes],
    ValueType<number>
  >;
  clinicalSignData: Record<
    (typeof CLINICAL_SIGNS)[keyof typeof CLINICAL_SIGNS],
    ValueType<(typeof ConditionResult)[keyof typeof ConditionResult]>
  >;
  biologicalData: Record<
    (typeof BIOCHEMICAL_REF_CODES)[keyof typeof BIOCHEMICAL_REF_CODES],
    ValueType<number>
  >;
  appetiteTestResult: {
    [APPETITE_TEST_CODES.CODE]: ValueType<APPETITE_TEST_RESULT_CODES>;
  };
  complicationData: Record<
    string,
    ValueType<(typeof ConditionResult)[keyof typeof ConditionResult]>
  >;
  otherData: {
...
export class PatientCurrentState extends Entity<IPatientCurrentState> {
  ...
  addBiologicalData(
    code: (typeof BIOCHEMICAL_REF_CODES)[keyof typeof BIOCHEMICAL_REF_CODES],
    value: number,
    date: DomainDate
  ) {
  ...
  addAppetiteTestResult(
    code: string,
    value: APPETITE_TEST_RESULT_CODES,
    date: DomainDate
  ) {
    this.props.appetiteTestResult[code as "appetite_test_result"] = {
      code,
      value,
      date,
    };
  ...
  getAnthroVariables(): Record<string, number> {
    return Object.fromEntries(
      Object.values(this.props.anthropometricData).map(value => [
        value.code,
        value.value,
      ])
    );
  ...
  getClinicalVariables(): Record<string, number> {
    return Object.fromEntries(
      Object.values(this.props.clinicalSignData).map(value => [
        value.code,
        value.value,
      ])
    );
  ...
  getBiologicalVariables(): Record<string, number> {
    return Object.fromEntries(
      Object.values(this.props.biologicalData).map(value => [
        value.code,
        value.value,
      ])
    );
  ...
  getAppetiteTestVariables(): Record<string, APPETITE_TEST_RESULT_CODES> {
    return Object.fromEntries(
      Object.values(this.props.appetiteTestResult).map(value => [
        value.code,
        value.value,
      ])
    );
  }
  getComplicationVariables(): Record<
    string,
    (typeof ConditionResult)[keyof typeof ConditionResult]
  > {
    return {
      [COMPLICATION_CODES.COMPLICATIONS_NUMBER]: Object.values(
        this.props.complicationData
      ).reduce(
        (
          complication_number: number,
          currentComplication: ValueType<number>
        ) =>
          currentComplication.value === ConditionResult.True
            ? complication_number + 1
            : complication_number,
        0
      ),
    };
  ...
  static create(
    createProps: CreateCurrentStateProps,
    id: AggregateID
  ): Result<PatientCurrentState> {
    try {
      ...
      const anthropometricData = Object.fromEntries(
        Object.keys(createProps.anthropometricData).map(key => [
          key,
          {
            value: createProps.anthropometricData[key as AnthroSystemCodes],
            code: key,
            date,
          },
        ])
      ...
      const clinicalSignData = Object.fromEntries(
        Object.keys(createProps.clinicalSignData).map(key => [
          ...
          {
            value:
              createProps.clinicalSignData[
                key as (typeof CLINICAL_SIGNS)[keyof typeof CLINICAL_SIGNS]
              ],
            code: key,
            date,
          },
      ...
      const biologicalData = Object.fromEntries(
        Object.keys(createProps.biologicalData).map(key => [
          ...
          {
            value:
              createProps.biologicalData[
                key as (typeof BIOCHEMICAL_REF_CODES)[keyof typeof BIOCHEMICAL_REF_CODES]
              ],
            code: key,
            date,
          },
      ...
      const appetiteTestData = Object.fromEntries(
        Object.keys(createProps.appetiteTestResult).map(key => [
          ...
          {
            value:
              createProps.appetiteTestResult[key as "appetite_test_result"],
            code: key,
            date,
          },
        ])
      ...
      const complicationData = Object.fromEntries(
        Object.keys(createProps.complicationData).map(key => [
          key,
          { value: createProps.complicationData[key], code: key, date },
        ])
      );
      ...
      return Result.ok(
        new PatientCurrentState({
          id,
          props: {
            anthropometricData: anthropometricData as Record<
              (typeof AnthroSystemCodes)[keyof typeof AnthroSystemCodes],
              ValueType<number>
            >,
            clinicalSignData: clinicalSignData as Record<
              ...
              ValueType<(typeof ConditionResult)[keyof typeof ConditionResult]>
            >,
            biologicalData: biologicalData as Record<
              (typeof BIOCHEMICAL_REF_CODES)[keyof typeof BIOCHEMICAL_REF_CODES],
              ValueType<number>
            >,
