import { Reminder, CreateReminderProps } from '@reminders/domain/models/aggregate/Reminder';
import { AggregateID, DateTime, Result } from '@shared';
import { mock, MockProxy } from 'jest-mock-extended';
import { ReminderAction, ReminderTrigger } from '@reminders/domain/models/valueObject';
import { ReminderActionType, ReminderTriggerType } from '@reminders/domain/models/constants';
