...
import { MonitoringEntry, ClinicalEvent, NutritionalTreatmentAction } from "@/core/nutrition_care/domain/core/models/valueObjects";
...
describe("DailyCareJournal", () => {
    ...
    it("should add a monitoring value", () => {
        ...
        // Assert
        expect(journal.getMonitoringValues()).toContainEqual(monitoringEntry.unpack());
    });
