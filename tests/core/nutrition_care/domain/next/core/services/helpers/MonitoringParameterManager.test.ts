...
describe("MonitoringParameterManager", () => {
    ...
    beforeEach(() => {
        ...
        manager = new MonitoringParameterManager(idGenerator, treatmentDateManagementService);
    ...
    it("should synchronize monitoring parameters", () => {
        ...
        // Act
        const result = manager.synchronizeMonitoringParameters(recommendedElements, currentParameters);
