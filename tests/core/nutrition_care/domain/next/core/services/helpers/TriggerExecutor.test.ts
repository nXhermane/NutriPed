...
import { CarePhase, OnGoingTreatment } from "@/core/nutrition_care/domain/next/core/models";
...
describe("TriggerExecutor", () => {
    ...
    it("should execute all triggers", async () => {
        ...
        // Act
        const result = await executor.executeAllTriggers(newTreatments, stoppedTreatments, recommendedTreatments, carePhase);
