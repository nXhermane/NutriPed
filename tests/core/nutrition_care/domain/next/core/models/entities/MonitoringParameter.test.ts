...
} from "@/core/nutrition_care/domain/next/core/models/entities/MonitoringParameter";
...
describe("MonitoringParameter", () => {
  beforeEach(() => {
    (MonitoringParameterElement.create as jest.Mock).mockReturnValue(
      Result.ok({} as MonitoringParameterElement)
    );
  });
