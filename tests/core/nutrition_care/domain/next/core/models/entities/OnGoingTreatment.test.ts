import { OnGoingTreatment, CreateOnGoindTreatment, OnGoingTreatmentStatus } from "@/core/nutrition_care/domain/next/core/models/entities/OnGoingTreatment";
...
describe("OnGoingTreatment", () => {
    beforeEach(() => {
        (OnGoingTreatmentRecommendation.create as jest.Mock).mockReturnValue(Result.ok({} as OnGoingTreatmentRecommendation));
    });
