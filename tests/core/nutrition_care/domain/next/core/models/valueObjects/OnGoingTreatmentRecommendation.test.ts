import { OnGoingTreatmentRecommendation, CreateOnGoingTreatmentRecommendation } from "@/core/nutrition_care/domain/next/core/models/valueObjects/OnGoingTreatmentRecommendation";
import { RECOMMENDED_TREATMENT_TYPE, TREATMENT_PLAN_IDS, DURATION_TYPE, FREQUENCY_TYPE, MEDICINE_CODES } from "@/core/constants";
