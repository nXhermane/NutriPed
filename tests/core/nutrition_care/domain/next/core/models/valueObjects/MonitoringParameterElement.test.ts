import { MonitoringParameterElement, CreateMonitoringParameterElement } from "@/core/nutrition_care/domain/next/core/models/valueObjects/MonitoringParameterElementData";
import { MONITORING_ELEMENT_CATEGORY, MONITORING_VALUE_SOURCE, AnthroSystemCodes, DURATION_TYPE, FREQUENCY_TYPE } from "@/core/constants";
import { Frequency, Duration } from "@/core/nutrition_care/domain/modules";
import { Result } from "@/core/shared";

jest.mock("@/core/nutrition_care/domain/modules/carePhase/models/valueObjects/MonitoringFrequency");
jest.mock("@/core/nutrition_care/domain/modules/carePhase/models/valueObjects/TreatmentDuration");
