import { OrientationAppService, OrientationServiceUseCases } from "@/core/nutrition_care/application/services/OrientationService";
import { CreateOrientationRefRequest, GetOrientationRefRequest, OrientRequest } from "@/core/nutrition_care/application/useCases";
...
describe("OrientationAppService", () => {
    ...
    describe("create", () => {
        it("should return the id on successful creation", async () => {
            // Arrange
            const request: CreateOrientationRefRequest = { code: "test", name: "Test" };
    ...
    describe("orient", () => {
        it("should return the orientation result on successful retrieval", async () => {
            ...
            mockUseCases.orientUC.execute.mockResolvedValue(right(Result.ok(response as any)));
