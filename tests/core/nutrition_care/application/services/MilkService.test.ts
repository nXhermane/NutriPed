import { MilkAppService, MilkServiceUseCases } from "@/core/nutrition_care/application/services/MilkService";
import { CreateMilkRequest, GetMilkRequest, SuggestMilkRequest } from "@/core/nutrition_care/application/useCases";
...
describe("MilkAppService", () => {
    ...
    describe("suggestMilk", () => {
        it("should return the milk suggestion on successful retrieval", async () => {
            ...
            mockUseCases.suggestMilkUC.execute.mockResolvedValue(right(Result.ok(response as any)));
