...
import { DateBuilder } from '../../../../../utils/TestBuilders';
import {
...
describe('DomainDate', () => {
  ...
  describe('validate', () => {
    it('should throw ArgumentNotProvidedException when date is empty', () => {
      expect(() => {
  ...
  describe('isLeapYear', () => {
    ...
    it('should return false for non-leap years', () => {
      const nonLeapYears = ['2021-01-01', '2022-01-01', '2023-01-01', '2100-01-01'];
