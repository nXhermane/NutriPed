...
export function useOrdoredMedicalRecordDataByDay(
  ...
  useEffect(() => {
    ...
    const groupedData: {
      [date: string]: MedicalRecordDataOrdoredByDay[number];
    } = {};
    ...
    const sortedArray: MedicalRecordDataOrdoredByDay = Object.values(
      groupedData
