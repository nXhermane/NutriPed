...
import { BirthDateField, dateZodSchema, EdemaField, EdemaZodSchema, WeightField, WeightZodSchema } from "./sharedAnthropometricDataForm";
...
export const SuggestMilkFormZodSchema = {
    validate(data: any) {
        const zodSchemaLists: z.ZodTypeAny[] = [
            ...
            z.object({
                [APPETITE_TEST_CODES.CODE]: z.enum([APPETITE_TEST_RESULT_CODES.BAD, APPETITE_TEST_RESULT_CODES.GOOD])
            }),
            z.object({
