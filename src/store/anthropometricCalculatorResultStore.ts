...
export const anthropometricCalculatorSlice = createSlice({
  ...
  reducers: {
    addAnthropometricCalculatorResult(
      state,
      action: PayloadAction<AddAnthropometricCalculatorResultData>
    ) {
...
export const {
  addAnthropometricCalculatorResult,
  deleteAnthropometricCalculatorResult,
} = anthropometricCalculatorSlice.actions;
export const anthropometricCalculatorResultReducer =
  anthropometricCalculatorSlice.reducer;
