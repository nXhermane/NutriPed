import {
  CreateGrowthReferenceTableProps,
...
export class GrowthReferenceTableInfraMapper
  implements
    InfrastructureMapper<
      GrowthReferenceTable,
    ...
    >
{
  ...
  toDomain(record: GrowthReferenceTablePersistenceDto): GrowthReferenceTable {
    const growthRefTableRes = GrowthReferenceTable.create(
      record as CreateGrowthReferenceTableProps,
      record.id
    );
    if (growthRefTableRes.isFailure)
