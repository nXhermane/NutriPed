...
} from "@core/diagnostics/domain/core/services";
import {
...
export class DiagnosticContext {
  ...
  private readonly validateMeasurementDataUC: UseCase<
    ...
    ValidateMeasurementsResponse
  >;
  private readonly makeClinicalSignInterpretationUC: UseCase<MakeClinicalSignDataInterpretationRequest, MakeClinicalSignDataInterpretationResponse>
  // Subscribers
  ...
  private constructor(
    ...
    this.makeClinicalSignInterpretationUC = new MakeClinicalSignDataInterpretationUseCase(this.nutritionalDiagnosticRepo, this.makeClinicalAnalysisUC)
    // Subscribers
    ...
    this.makeClinicalSignInterpretationAppService = new MakeClinicalSignDataInterpretationService({
