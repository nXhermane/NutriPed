...
export class ClinicalSignReferenceInfraMapper implements InfrastructureMapper<NextClinicalDomain.ClinicalSignReference, NextClinicalInfraDtos.ClinicalSignReferencePersistenceDto> {
    toPersistence(entity: NextClinicalDomain.ClinicalSignReference): NextClinicalInfraDtos.ClinicalSignReferencePersistenceDto {
        return {
            id: entity.id,
            code: entity.getCode(),
    ...
    toDomain(record: NextClinicalInfraDtos.ClinicalSignReferencePersistenceDto): NextClinicalDomain.ClinicalSignReference {
