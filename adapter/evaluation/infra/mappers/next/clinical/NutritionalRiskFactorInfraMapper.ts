...
export class NutritionalRiskFactorInfraMapper implements InfrastructureMapper<NextClinicalDomain.NutritionalRiskFactor, NextClinicalInfraDtos.NutritionalRiskFactorPersistenceDto> {
    toPersistence(entity: NextClinicalDomain.NutritionalRiskFactor): NextClinicalInfraDtos.NutritionalRiskFactorPersistenceDto {
        return {
            id: entity.id,
    ...
    toDomain(record: NextClinicalInfraDtos.NutritionalRiskFactorPersistenceDto): NextClinicalDomain.NutritionalRiskFactor {
        const nutritionalRiskFactorRes = NextClinicalDomain.NutritionalRiskFactor.create(
            record,
            record.id
        );
