import {
  CreateGrowthReferenceChartProps,
...
export class GrowthReferenceChartInfraMapper
  implements
    InfrastructureMapper<
      GrowthReferenceChart,
    ...
    >
{
  ...
  toDomain(record: GrowthReferenceChartPersistenceDto): GrowthReferenceChart {
    const growthReferenceChartRes = GrowthReferenceChart.create(
      record as CreateGrowthReferenceChartProps,
      record.id
    );
    if (growthReferenceChartRes.isFailure)
      throw new InfraMapToDomainError(
        formatError(
          growthReferenceChartRes,
