...
import { CarePhaseReference, CarePhaseReferenceRepository, MonitoringElementRepository, RecommendedTreatmentRepository } from "@/core/nutrition_care";
...
import { RepositoryException, RepositoryNotFoundError } from "@/adapter/shared/repository.expo/expo.repository.errors";
...
export class CarePhaseReferenceRepositoryExpo
    ...
    private async saveWithTransaction(
        ...
        if (props.recommendedTreatments && Array.isArray(props.recommendedTreatments)) {
