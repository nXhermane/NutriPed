...
import { CreateFollowUpAction, MonitoringElement, RecommendedTreatment } from "@/core/nutrition_care/domain";
...
export interface CarePhaseReferencePersistenceRecordDto extends EntityPersistenceDto {
  code: CARE_PHASE_CODES;
  name: string;
  description: string;
  nextPhaseCode?: CARE_PHASE_CODES;
