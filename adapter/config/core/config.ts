...
export const CORE_CONFIG = {
  ...
  anthropometricCalculatorResultExportTemplateUrl: `https://cdn.jsdelivr.net/gh/nxh-labs/Pediatric_Software_Data_Extraction${version}/dist/export_anthropometric_result_template.xlsx.pdf`
} as const;
