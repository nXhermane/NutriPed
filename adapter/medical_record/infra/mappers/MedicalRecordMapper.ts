import { AnthropometricData, BiologicalValue, ClinicalSignData, ComplicationData, DataFieldResponse, MedicalRecord } from "@core/medical_record";
import { InfrastructureMapper, Result, InfraMapToDomainError, formatError } from "@shared";
